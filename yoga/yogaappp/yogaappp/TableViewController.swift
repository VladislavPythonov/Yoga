...
class TableViewController: UITableViewController, WCSessionDelegate {
    ...
    struct lessions {
        ...
        static func getLessions() -> [lessions] {
            return [
                ...
                lessions(name: "Лотус", time: 13.0, image: "juravl"),
            ]
        }
    }
    ...
    func session(_ sesions: WCSession, activationDidCompleteWith activationState:
                 WCSessionActivationState, error: Error?)
    {
        
    }
    
    func sesssionDidBecomeInactive(_ session: WCSession){
